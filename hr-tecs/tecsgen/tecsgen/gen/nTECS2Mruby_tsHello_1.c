...
#include "nTECS2Mruby_tsHello_1_tecsgen.h"
 ...
 * name:         eEnt_func
 * global_name:  nTECS2Mruby_tsHello_1_eEnt_func
 * oneway:       false
 * #[</ENTRY_FUNC>]# */
void
eEnt_func(CELLIDX idx)
{
  tsHello_1_CB    *p_cellcb;
  if( VALID_IDX( idx ) ){
 ...
 * name:         eEnt_func1
 * global_name:  nTECS2Mruby_tsHello_1_eEnt_func1
 * oneway:       false
 * #[</ENTRY_FUNC>]# */
int16_t
 ...
 * name:         eEnt_func2
 * global_name:  nTECS2Mruby_tsHello_1_eEnt_func2
 * oneway:       false
 * #[</ENTRY_FUNC>]# */
int32_t
 ...
 * name:         eEnt_func3
 * global_name:  nTECS2Mruby_tsHello_1_eEnt_func3
 * oneway:       false
 * #[</ENTRY_FUNC>]# */
int32_t
